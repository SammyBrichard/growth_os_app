...
function PricingInfo() {
  ...
  return (
    <div style={{ borderTop: `1px solid ${C.border}`, paddingTop: 4 }}>
      <button onClick={() => setOpen(o => !o)} style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6, padding: '8px 0', fontFamily: MONO, fontSize: 11, color: C.muted }}>
        <span style={{ fontSize: 13 }}>{open ? '▾' : '▸'}</span>
        Pricing assumptions
      </button>
      {open && (
        <div style={{ marginTop: 8, background: C.cream, border: `1px solid ${C.border}`, borderRadius: 8, overflow: 'hidden' }}>
